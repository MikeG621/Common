/*
 * Idmr.Common.FileSaveException.cs, Exception class for save failures
...
namespace Idmr.Common
{
	...
	public class FileSaveException : Exception
	{
		...
		public FileSaveException(string message, Exception innerEx)
            : base(message, innerEx)
		{
		}

        /// <summary>Create a new exception using serialized data</summary>
        protected FileSaveException(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
            : base(info, context) { }
	}
}